    ...
    useEffect(() => {
        const fetchMenuData = async () => {
            try {
                ...
                const menu = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/pesanan/menu/${uuid}`);
                if (!menu.ok) {
                ...
                const resPesanan = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/pesanan/${uuid}`);
                if (resPesanan.ok) {
                    ...
                    const firstAvailable = data.find(menu => !sessions.includes(menu.namaMenu));
                    if (firstAvailable) {
        ...
        <div className="min-h-screen bg-gray-400 px-6 py-16">
            ...
            <div className="text-center mb-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4">
                    <div>
                        <h1 className="text-white text-2xl sm:text-3xl font-semibold">Menu Hari Ini</h1>
                    </div>

...
import { PantanganForm, MakananOption, CreatePatientFormData } from "../types/patient"
                                                    ...
                                                    <CommandGroup>
                                                        {makananOptions.map((makanan) => (
                                                            <CommandItem
                                                                ...
                                                                onSelect={() => {
                                                                    handleRestrictionChange(index, "makananId", makanan.idMakanan)
                                                                }}
                                                            >
                                                                <Check
                                                                    className={cn(
                                                                        "mr-2 h-4 w-4",
                                                                        restriction.makananId === makanan.idMakanan ? "opacity-100" : "opacity-0"
                                                                    )}
                                                                />
                                                                {makanan.namaMakanan}
                                                            </CommandItem>
